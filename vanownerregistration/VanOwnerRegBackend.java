...
public class VanOwnerRegBackend extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    VanOwnerRegBackend(Context ctx){
        context= ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String reg_url="http://192.168.1.102/smartvan/ownerRegistration.php";
        if (type.equals("reg")){
            try {
                String NIC=params[1];
                ...
                String GovtLicenceNum=params[6];
                String Address=params[7];
                String contactNumber=params[8];
                ...
                String post_data= URLEncoder.encode("NIC","UTF-8")+"="+URLEncoder.encode(NIC,"UTF-8")+"&"+
                        ...
                        URLEncoder.encode("GovtLicenceNum","UTF-8")+"="+URLEncoder.encode(GovtLicenceNum,"UTF-8")+"&"+
